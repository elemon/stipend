...
*  Title: Animpedia v1                                          *
*    Description:                                               *
*    This file will be used as an example to Scaffold the Final *
*    Database Rotation Project; Geniuses will modify this code  *
*    to create an app that they will use to keep track of their *
*    Stipends                                                   *
*                                                               *
*                                                               *
****************************************************************/
...
def load_viewer(): #updates the viewer widget
    try:
        cursor.execute('Select character,title,ability,birthday,sex from CHARACTERS')
...
connection = create_connection('animpedia_db')
