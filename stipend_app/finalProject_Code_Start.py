...
*   1. Modify database name and root title name
    ...
    4. Modify cursor.execute value
    5. Delete load_viewer function
    6  Delete root.after_idle(load_viewer)
    7. Modify the the child Widgets
    7. Delete Vertical Divider code
    8. Delete Viewer 
    9. MODIFY Drop buttonn to Update
                          *
*                                                               *
****************************************************************/
"""
